...
import blogdetails from "../../assets/imgs/blog/blog-details.png"
            ...
            <div className='p-70'>
                <div className="custom-container blog-container1">
                    ...
                    <div className='social-main' data-gsap>
                        <ul className='blogd'>
                            ...
                            <li><svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                <path d="M7.19922 3.60001V7.20001L9.59922 8.40001M13.1992 7.20001C13.1992 10.5137 10.5129 13.2 7.19922 13.2C3.88551 13.2 1.19922 10.5137 1.19922 7.20001C1.19922 3.8863 3.88551 1.20001 7.19922 1.20001C10.5129 1.20001 13.1992 3.8863 13.1992 7.20001Z" stroke="black" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>19-09-2026</li>
                        </ul>
                    ...
                    <div className="blogdata" data-gsap>
                        ...
                        <h2>What is billboard advertising?</h2>
                        <p>Web designing in a powerful way of just n professions, however, in  passion for a our Company. We hatendency to believe the idea that sm Technology is a broad category encompassing all aspects Web designing in a powerful way of just n professio, howein  passion for a our Company. We hatendency to believe the idea that sm Technology is a broad </p>
                        <p>Web designing in a powerful way of just n professions, however, in  passion for a our Company. We hatendency to believe the idea that sm Technology is a broad category encompassing all aspects Web designing in a powerful =</p>
                        <h2>How much does a billboard cost?</h2>
                        <p>Web designing in a powerful way of just n professions, however, in  passion for a our Company. We hatendency to believe the idea that sm Technology is a broad category encompassing all aspects Web designing in a powerful =</p>
                        <figure>
                            <img src={blog2} alt="" />
                        </figure>
                        ...
                        <h2>How can I measure a billboard’s performance?</h2>

                        <p>Web designing in a powerful way of just n professions, however, in  passion for a our Company. We hatendency to believe the idea that sm Technology is a broad category encompassing all aspects Web designing in a powerful =</p>
                        <h2>Supercharge Your Business with Billboards</h2>
                        <p>Web designing in a powerful way of just n professions, however, in  passion for a our Company. We hatendency to believe the idea that sm Technology is a broad category encompassing all aspects Web designing in a powerful =</p>
                    </div>
