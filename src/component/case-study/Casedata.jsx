...
import { getCaseStudyDetailApi } from "../../utils/frontApi";
...
import TestimonialSlider2 from "../home/TestimonialSlider2";
import CaseStudyCard from "../reuse/CaseStudyCard";
import AboutCTA from "../about/AboutCTA";
import { Helmet } from "react-helmet-async";
const Casedata = ({ setCaseName }) => {
  ...
  const share = (type) => {
    ...
    switch (type) {
      ...
      case "instagram":
        alert(
          "Instagram direct web sharing support nahi karta. Link copy karke Instagram Story/Bio me use kare.",
        );
